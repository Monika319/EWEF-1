...
files = ["zad5R10.dat","simzad5R10.dat"]
Dane=[] #empty table
...
Xsim=Dane[1][:, 0]
Ysim=10**(Dane[1][:, 1]/20.)
plt.plot(Xsim, Ysim, "-", label=u"Symulacja Q=5,67")
...
plt.plot([13322,13322], [0,Ysim_quality], "k--")
plt.plot([15889,15889], [0,Ysim_quality], "k--")
...
plt.show()
np.savetxt("YsimR10rownolegl",np.transpose([Ysim, Xsim]))
#np.savetxt("YexR10rownolegl",np.transpose([Yex, Xex]))
